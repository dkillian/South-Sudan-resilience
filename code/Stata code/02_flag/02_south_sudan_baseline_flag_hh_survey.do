...
* July 20, 2021
*******************************************************************************
* File uses: mesp_household_baseline_survey_english_hh_schedule_preprocessed.dta;
* mesp_household_baseline_survey_english_preprocessed.dta;
* mesp_household_baseline_survey_nuer_hh_schedule_preprocessed.dta;
* mesp_household_baseline_survey_nuer_preprocessed.dta;
* mesp_household_baseline_survey_murle_hh_schedule_preprocessed.dta;
* mesp_household_baseline_survey_murle_preprocessed.dta;
* mesp_household_baseline_survey_jie_hh_schedule_preprocessed.dta;
* mesp_household_baseline_survey_jie_preprocessed.dta;
* mesp_household_baseline_survey_dinka_hh_schedule_preprocessed.dta;
* mesp_household_baseline_survey_dinka_preprocessed.dta;
* mesp_household_baseline_survey_didinga_hh_schedule_preprocessed.dta;
* mesp_household_baseline_survey_didinga_preprocessed.dta;
********************************************************************************
* File saves: south_sudan_hh_survey_baseline_flags_english_list.txt
* south_sudan_hh_survey_schedule_baseline_flags_english_list.txt
* south_sudan_hh_survey_baseline_flags_nuer_list.txt
* south_sudan_hh_survey_schedule_baseline_flags_nuer_list.txt
* south_sudan_hh_survey_baseline_flags_murle_list.txt
* south_sudan_hh_survey_schedule_baseline_flags_murle_list.txt
* south_sudan_hh_survey_baseline_flags_jie_list.txt
* south_sudan_hh_survey_schedule_baseline_flags_jie_list.txt
* south_sudan_hh_survey_baseline_flags_dinka_list.txt
* south_sudan_hh_survey_schedule_baseline_flags_dinka_list.txt
* south_sudan_hh_survey_baseline_flags_didinga_list.txt
* south_sudan_hh_survey_schedule_baseline_flags_didinga_list.txt
********************************************************************************
...
local langz didinga dinka english jie murle nuer

foreach lng of local langz {
use "`inpath'mesp_household_baseline_survey_`lng'_preprocessed.dta", clear 
...
replace boma = "Pagak" if strpos(q_201_204, "Pagak")
...
replace ea = "720404002201" if strpos(q_201_204, "720404002201")
replace ea = "720403002201" if strpos(q_201_204, "720403002201")
replace ea = "720403003202" if strpos(q_201_204, "720403003202")
replace ea = "720405005206" if strpos(q_201_204, "720405005206")
replace ea = "930602002201" if strpos(q_201_204, "930602002201")
replace ea = "930604004202" if strpos(q_201_204, "930604004202")
replace ea = "720905006201" if strpos(q_201_204, "720905006201")
replace ea = "720703001101" if strpos(q_201_204, "720703001101")
replace ea = "720705003205" if strpos(q_201_204, "720705003205")
replace ea = "720703003202" if strpos(q_201_204, "720703003202")
...
label def mnt 3 "March" 4 "April" 5 "May" 6 "June" 7 "July"
label val month mnt
tab month, m
...
*Screening
cap rm "`outpath'south_sudan_hh_survey_baseline_flags_`lng'_list.txt"
cap file close myfile1
file open myfile1 using "`outpath'south_sudan_hh_survey_baseline_flags_`lng'_list.txt", write
...
file close myfile1
drop rowid
save "`outpath'mesp_household_baseline_survey_`lng'_hh_flag.dta", replace
}
*
...
foreach lng of local langz {
use "`inpath'mesp_household_baseline_survey_`lng'_hh_schedule_preprocessed.dta", clear 

*New var for rowid
gen rowid=_n

*Screening
cap rm "`outpath'south_sudan_hh_survey_schedule_baseline_flags_`lng'_list.txt"
cap file close myfile1
file open myfile1 using "`outpath'south_sudan_hh_survey_schedule_baseline_flags_`lng'_list.txt", write
...
save "`outpath'mesp_household_baseline_survey_`lng'_hh_schedule_flag.dta", replace
}
*
ATTENZIONE

use "`outpath'mesp_household_baseline_survey_didinga_hh_flag_dqc_13July2021.dta", clear
append using "`outpath'mesp_household_baseline_survey_dinka_hh_flag_dqc_13July2021.dta", force
append using "`outpath'mesp_household_baseline_survey_english_hh_flag_dqc_13July2021.dta", force
append using "`outpath'mesp_household_baseline_survey_jie_hh_flag_dqc_13July2021.dta", force
append using "`outpath'mesp_household_baseline_survey_murle_hh_flag_dqc_13July2021.dta", force
append using "`outpath'mesp_household_baseline_survey_nuer_hh_flag_dqc_13July2021.dta", force
...
save "`outpath'mesp_household_baseline_survey_combined_hh_flag_dqc_13July2021.dta", replace
