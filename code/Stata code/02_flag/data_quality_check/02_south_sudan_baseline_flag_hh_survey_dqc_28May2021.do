...
* May 28, 2021
*******************************************************************************
* File uses: mesp_household_baseline_survey_english_hh_schedule_preprocessed_dqc_28May2021.dta;
* mesp_household_baseline_survey_english_preprocessed_dqc_28May2021.dta;
* mesp_household_baseline_survey_nuer_hh_schedule_preprocessed_dqc_28May2021.dta;
* mesp_household_baseline_survey_nuer_preprocessed_dqc_28May2021.dta;
* mesp_household_baseline_survey_murle_hh_schedule_preprocessed_dqc_28May2021.dta;
* mesp_household_baseline_survey_murle_preprocessed_dqc_28May2021.dta;
* mesp_household_baseline_survey_jie_hh_schedule_preprocessed_dqc_28May2021.dta;
* mesp_household_baseline_survey_jie_preprocessed_dqc_28May2021.dta;
********************************************************************************
* File saves: south_sudan_hh_survey_baseline_flags_english_dqc_28May2021_list.txt
* south_sudan_hh_survey_schedule_baseline_flags_english_dqc_28May2021_list.txt
* south_sudan_hh_survey_baseline_flags_nuer_dqc_28May2021_list.txt
* south_sudan_hh_survey_schedule_baseline_flags_nuer_dqc_28May2021_list.txt
* south_sudan_hh_survey_baseline_flags_murle_dqc_28May2021_list.txt
* south_sudan_hh_survey_schedule_baseline_flags_murle_dqc_28May2021_list.txt
* south_sudan_hh_survey_baseline_flags_jie_dqc_28May2021_list.txt
* south_sudan_hh_survey_schedule_baseline_flags_jie_dqc_28May2021_list.txt
********************************************************************************
...
local langz nuer english murle jie

foreach lng of local langz {
use "`inpath'mesp_household_baseline_survey_`lng'_preprocessed_dqc_28May2021.dta", clear 
...
gen payam = "."
replace payam = "Adok(Leer)" if strpos(q_201_204, "Adok(Leer)")
replace payam = "Ageer" if strpos(q_201_204, "Ageer")
replace payam = "Alali" if strpos(q_201_204, "Alali")
replace payam = "Barmach" if strpos(q_201_204, "Barmach")
...
replace payam = "Buong(Bwong)" if strpos(q_201_204, "Buong(Bwong)")
replace payam = "Dengjok" if strpos(q_201_204, "Dengjok")
replace payam = "Diror" if strpos(q_201_204, "Diror")
replace payam = "Dok(Leer)" if strpos(q_201_204, "Dok(Leer)")
...
replace payam = "Puolchuol(Pulchuol)" if strpos(q_201_204, "Puolchuol(Pulchuol)")
...
*Screening
cap rm "`outpath'south_sudan_hh_survey_baseline_flags_`lng'_dqc_28May2021_list.txt"
cap file close myfile1
file open myfile1 using "`outpath'south_sudan_hh_survey_baseline_flags_`lng'_dqc_28May2021_list.txt", write
file write myfile1 "sno" _tab "Freq" _tab "record_id2" _tab "description" _tab "Condition"

****HH Questionnaire****
egen record_id2 = concat(record_id q_209 assigned_to), punc("_")
...
local i = `i'+1
levelsof record_id2 if survey_minutes2<45, local(record_id2) clean
local ids_freq: word count `record_id2'
file write myfile1 _newline  "`i'" _tab "`ids_freq'" _tab "`record_id2'" _tab "Survey less than 45 minutes" _tab `"if survey_minutes2<45"'
...
local ids_freq: word count `record_id2'
file write myfile1 _newline  "`i'" _tab "`ids_freq'" _tab "`record_id2'" _tab "Duplicate entry" _tab `"state county boma payam q_205 q_403 q_404 q_405 q_406 q_407 q_408 q_409 q_410 q_411 q_412 q_413 q_414 q_415 q_416 q_417 q_418 q_419"'
...
foreach lng of local langz {
use "`inpath'mesp_household_baseline_survey_`lng'_hh_schedule_preprocessed_dqc_28May2021.dta", clear 

*New var for rowid
gen rowid=_n

*Screening
cap rm "`outpath'south_sudan_hh_survey_schedule_baseline_flags_`lng'_dqc_28May2021_list.txt"
cap file close myfile1
file open myfile1 using "`outpath'south_sudan_hh_survey_schedule_baseline_flags_`lng'_dqc_28May2021_list.txt", write
file write myfile1 "sno" _tab "Freq" _tab "record_id2" _tab "description" _tab "Condition"
...
local ids_freq: word count `child_record_id2'
...
local i = `i'+1
levelsof child_record_id2 if q_308==., local(child_record_id2) clean
local ids_freq: word count `child_record_id2'
file write myfile1 _newline  "`i'" _tab "`ids_freq'" _tab "`child_record_id2'" _tab "Highest edu level is missing" _tab `"if q_308==."'
