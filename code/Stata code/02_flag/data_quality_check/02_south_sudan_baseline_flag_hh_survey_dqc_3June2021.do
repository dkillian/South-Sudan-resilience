...
* May 28, 2021
*******************************************************************************
* File uses: mesp_household_baseline_survey_english_hh_schedule_preprocessed_dqc_3June2021.dta;
* mesp_household_baseline_survey_english_preprocessed_dqc_3June2021.dta;
* mesp_household_baseline_survey_nuer_hh_schedule_preprocessed_dqc_3June2021.dta;
* mesp_household_baseline_survey_nuer_preprocessed_dqc_3June2021.dta;
* mesp_household_baseline_survey_murle_hh_schedule_preprocessed_dqc_3June2021.dta;
* mesp_household_baseline_survey_murle_preprocessed_dqc_3June2021.dta;
* mesp_household_baseline_survey_jie_hh_schedule_preprocessed_dqc_3June2021.dta;
* mesp_household_baseline_survey_jie_preprocessed_dqc_3June2021.dta;
********************************************************************************
* File saves: south_sudan_hh_survey_baseline_flags_english_dqc_3June2021_list.txt
* south_sudan_hh_survey_schedule_baseline_flags_english_dqc_3June2021_list.txt
* south_sudan_hh_survey_baseline_flags_nuer_dqc_3June2021_list.txt
* south_sudan_hh_survey_schedule_baseline_flags_nuer_dqc_3June2021_list.txt
* south_sudan_hh_survey_baseline_flags_murle_dqc_3June2021_list.txt
* south_sudan_hh_survey_schedule_baseline_flags_murle_dqc_3June2021_list.txt
* south_sudan_hh_survey_baseline_flags_jie_dqc_3June2021_list.txt
* south_sudan_hh_survey_schedule_baseline_flags_jie_dqc_3June2021_list.txt
********************************************************************************
...
use "`inpath'mesp_household_baseline_survey_`lng'_preprocessed_dqc_3June2021.dta", clear 
...
*Screening
cap rm "`outpath'south_sudan_hh_survey_baseline_flags_`lng'_dqc_3June2021_list.txt"
cap file close myfile1
file open myfile1 using "`outpath'south_sudan_hh_survey_baseline_flags_`lng'_dqc_3June2021_list.txt", write
...
file close myfile1
drop rowid
save "`outpath'mesp_household_baseline_survey_`lng'_hh_flag_dqc_3June2021.dta", replace
}
*
...
foreach lng of local langz {
use "`inpath'mesp_household_baseline_survey_`lng'_hh_schedule_preprocessed_dqc_3June2021.dta", clear 

*New var for rowid
gen rowid=_n

*Screening
cap rm "`outpath'south_sudan_hh_survey_schedule_baseline_flags_`lng'_dqc_3June2021_list.txt"
cap file close myfile1
file open myfile1 using "`outpath'south_sudan_hh_survey_schedule_baseline_flags_`lng'_dqc_3June2021_list.txt", write
...
save "`outpath'mesp_household_baseline_survey_`lng'_hh_schedule_flag_dqc_3June2021.dta", replace
}
*
