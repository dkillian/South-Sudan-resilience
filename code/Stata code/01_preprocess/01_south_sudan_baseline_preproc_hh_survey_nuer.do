...
* Sean Kelly
* July 20, 2021
* File uses: mesp_household_baseline_survey_nuer.xlsx
...
*Import raw dataset
import excel using "`inpath'mesp_household_baseline_nuer.xlsx", firstrow sheet("mesp_household_baseline_-_nuer") clear
...
rename BM q_402_t
rename BN q_402_u
rename mith_runwaa q_breakfast
rename kam_mithni q_snack_1
rename mith_cadaar q_lunch
rename snack_2 q_snack_2
rename mith_war q_dinner
...
gen survey_name = "Nuer HH Survey"

*Save dataset as dta file
save "`outpath'mesp_household_baseline_survey_nuer_preprocessed.dta", replace
...
*Import raw dataset
import excel using "`inpath'mesp_household_baseline_nuer.xlsx", firstrow sheet("mesp_household_baseline_-_nuer_") clear
...
*Save dataset as dta file
save "`outpath'mesp_household_baseline_survey_nuer_hh_schedule_preprocessed.dta", replace
