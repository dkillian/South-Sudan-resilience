...
* Sean Kelly
* July 20, 2021
* File uses: mesp_household_baseline_survey_jie.xlsx
* File saves: mesp_household_pilot_survey_jie_preprocessed.dta
* mesp_household_pilot_survey_jie_hh_schedule_preprocessed.dta
...
*Import raw dataset
import excel using "`inpath'mesp_household_baseline_survey_jie.xlsx", firstrow sheet("mesp_household_baseline_survey_") clear
...
gen survey_name = "Jie HH Survey"

*Save dataset as dta file
save "`outpath'mesp_household_baseline_survey_jie_preprocessed.dta", replace
...
*Import raw dataset
import excel using "`inpath'mesp_household_baseline_survey_jie.xlsx", firstrow sheet("mesp_household_baseline_surve_1") clear
...
replace q_308="." if q_308=="NEED TO REDO"
destring q_308, replace

*Apply codebook
applyCodebook using "`outpath'01_south_sudan_baseline_codebook_hh_survey_hh_schedule.xlsx", rename varlab recode vallab

*Save dataset as dta file
save "`outpath'mesp_household_baseline_survey_jie_hh_schedule_preprocessed.dta", replace
