...
* Sean Kelly
* June 20, 2021
* File uses: mesp_household_baseline_survey_dinka_13July2021.xlsx
* File saves: mesp_household_pilot_survey_nuer_preprocessed_dqc.dta
* mesp_household_pilot_survey_nuer_hh_schedule_preprocessed_dqc.dta
...
*Import raw dataset
import excel using "`inpath'mesp_household_baseline_survey_dinka.xlsx", firstrow sheet("mesp_household_baseline_survey_") clear
...
rename BM q_402_t
rename BN q_402_u
rename cm_mikduur q_breakfast
rename k_ye_reem_ q_snack_1
rename cm_de_akl_ q_lunch
rename snack_2 q_snack_2
rename cm_thi_ q_dinner
...
gen survey_name = "Dinka HH Survey"

*Save dataset as dta file
save "`outpath'mesp_household_baseline_survey_dinka_preprocessed.dta", replace
...
*Import raw dataset
import excel using "`inpath'mesp_household_baseline_survey_dinka.xlsx", firstrow sheet("mesp_household_baseline_surve_1") clear
...
*Save dataset as dta file
save "`outpath'mesp_household_baseline_survey_dinka_hh_schedule_preprocessed.dta", replace
