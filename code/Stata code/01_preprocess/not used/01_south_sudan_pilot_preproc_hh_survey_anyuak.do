...
* Sean Kelly
* April 12, 2021
* File uses: mesp_household_baseline_survey_anyuak.xlsx
* File saves: mesp_household_pilot_survey_anyuak_preprocessed.dta
* mesp_household_pilot_survey_didinga_hh_schedule_preprocessed.dta
...
*Import raw dataset
import excel using "`inpath'mesp_household_baseline_survey_anyuak.xlsx", firstrow sheet("mesp_household_baseline_survey_") clear
...
rename BL q_402_t
rename BM q_402_u
rename oniin q_breakfast
rename cam_mo_thiinh_jaak q_snack_1
rename cam_dhr_cng q_lunch
rename snack_2 q_snack_2
rename cam_wr q_dinner
...
save "`outpath'mesp_household_pilot_survey_anyuak_preprocessed.dta", replace
...
*Import raw dataset
import excel using "`inpath'mesp_household_baseline_survey_anyuak.xlsx", firstrow sheet("mesp_household_baseline_surve_1") clear
...
*Save dataset as dta file
save "`outpath'mesp_household_pilot_survey_anyuak_hh_schedule_preprocessed.dta", replace
