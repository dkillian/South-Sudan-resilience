...
* Sean Kelly
* September 3, 2021
* File uses: mesp_household_baseline_hh_survey_weighted2.dta
* mesp_household_pilot_survey_hh_schedule_clean.dta
* File saves: mesp_household_baseline_hh_survey_indicators_weighted2.xlsx
...
use "`inpath'mesp_household_baseline_hh_survey_weighted2.dta", clear
...
foreach survey in bvars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_b_overall") sheetmodify
...
foreach survey in bvars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_b_county_`bcj'") sheetmodify
...
foreach survey in bvars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_bin_location") sheetmodify
...
foreach survey in bvars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_bin_sex") sheetmodify
...
foreach survey in ovars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_o_overall") sheetmodify
...
foreach survey in ovars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_o_med_overall") sheetmodify
...
foreach survey in ovars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_o_county_`bcj'") sheetmodify
...
foreach survey in ovars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_o_med_county_`bcj'") sheetmodify
...
foreach survey in ovars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_ord_location") sheetmodify
...
foreach survey in ovars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_ord_med_location") sheetmodify
...
foreach survey in ovars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_ord_sex") sheetmodify
...
foreach survey in ovars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_ord_med_sex") sheetmodify
...
foreach survey in ivars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_i_overall") sheetmodify
...
foreach survey in ivars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_i_county_`bcj'") sheetmodify
...
foreach survey in ivars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_int_location") sheetmodify
...
foreach survey in ivars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_int_sex") sheetmodify
...
foreach survey in inravars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_inra_overall") sheetmodify
...
foreach survey in inravars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_inra_county_`bcj'") sheetmodify
...
foreach survey in inravars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_inra_location") sheetmodify
...
foreach survey in inravars  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_inra_sex") sheetmodify
...
use "`inpath'mesp_household_baseline_hh_survey_schedule_weighted2.dta", clear
...
foreach survey in vax  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_vax_overall") sheetmodify
...
foreach survey in vax  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_vax_county_`bcj'") sheetmodify
...
foreach survey in vax  {
	...
	file write myfile "Variable, Value"
	use "`inpath2'mesp_household_baseline_hh_survey_schedule_weighted2.dta", clear
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_vax_location") sheetmodify
...
foreach survey in vax  {
	...
	qui export excel using "`outpath'mesp_household_baseline_hh_survey_indicators_weighted2.xlsx", sheet("inds_vax_sex") sheetmodify
